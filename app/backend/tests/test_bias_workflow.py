...
class BiasWorkflowTests(unittest.TestCase):
    ...
    def test_flags_catalog_structure(self):
        ...
        self.assertTrue(
            any(entry['code'] == 'escalate_to_security' and entry['requiresFollowUp'] for entry in matrix['identity_mismatch'])
        )
        ...
        self.assertTrue(
            any(entry['code'] == 'escalate_to_policy' and entry['requiresFollowUp'] for entry in matrix['compliance_alert'])
        )
