...
import ReviewAudit from '@/components/Embassy/ReviewAudit'
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!ALLOWED_ROLES.includes(parsedOfficer.role)) {
        alert('Access denied. Audit queue is restricted to senior officers.')
        router.push('/embassy')
        return
      }
    ...
    return (
      <div className="min-h-screen bg-base-200 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-base-content/70">Preparing audit console…</p>
        </div>
      </div>
    )
  }
