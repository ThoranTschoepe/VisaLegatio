...
class DocumentAIService:
    def __init__(self, current_date: Optional[str] = None):
        ...
        self._current_date = current_date or datetime.utcnow().strftime("%Y-%m-%d")
    ...
    def set_current_date(self, value: Union[str, datetime]) -> None:
        """Override the analysis date used in prompts."""
        if isinstance(value, datetime):
            self._current_date = value.strftime("%Y-%m-%d")
        else:
